...
public partial class Methodic09 : Methodic
{
...
";
    ...
    public Methodic09()
    {
        t_9_1 = new(9.1, "Нормы времени на математическое моделирование моделирование",
    ...
    [ObservableProperty, NotifyPropertyChangedFor(nameof(Labor))] Table t_9_1;
