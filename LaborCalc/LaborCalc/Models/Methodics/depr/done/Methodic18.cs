...
public partial class Methodic18 : Methodic
{
...
";
    ...
    public Methodic18()
    {
        t_18_1 = new(18.1, "Нормы времени на изготовление и поставку оптических изделий",
    ...
    [JsonConstructor]
    public Methodic18(int a = 0) { }


    #region DATA

    [ObservableProperty, NotifyPropertyChangedFor(nameof(Labor))] Table t_18_1;
