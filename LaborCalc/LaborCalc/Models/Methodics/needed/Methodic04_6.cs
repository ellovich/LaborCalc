...
public partial class Methodic04_6 : Methodic // TODO _T_надстр
{
...
";
    ...
    [RelayCommand]
    void AddSuperstructure() => Superstructures.Add(new Superstructure($"Надстройка {Superstructures.Count + 1}", 0, _methodicCorrection));

    public partial class Superstructure : ViewModelBase
    {
        public static Methodic04_6 _outer;
    ...
    private Correction _methodicCorrection = s_Corrections4_8[0]; // общий коэффициент новизны работы
