...
";
    ...
    [ObservableProperty, NotifyPropertyChangedFor(nameof(Labor))] ObservableRangeCollection<Table> addedTables = new() { s_T_2_4, s_T_2_5 };
    ...
    public static List<Table> ReadyStepsTables { get; } = new() { s_T_2_1, s_T_2_2, s_T_2_3, s_T_2_6, s_T_2_8 };
    public static List<Table> SingleStepsTables { get; } = new() { s_T_2_4, s_T_2_5, s_T_2_7 };

    public static List<Item> ReadyStepsItems { get; } = new(ReadyStepsTables.SelectMany(t => t.TableItems));
    public static List<Item> SingleStepsItems { get; } = new(SingleStepsTables.SelectMany(t => t.TableItems));
